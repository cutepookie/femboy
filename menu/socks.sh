...
echo -e "${MB}————————————————————————————————————————————————————————${NC}"
echo -e ""
echo -e " ${WB}[1]${NC} ${GB}Create Account Socks5${NC} "
echo -e " ${WB}[2]${NC} ${GB}Trial Account Socks5${NC} "
echo -e " ${WB}[3]${NC} ${GB}Extend Account Socks5${NC} "
echo -e " ${WB}[4]${NC} ${GB}Delete Account Socks5${NC} "
