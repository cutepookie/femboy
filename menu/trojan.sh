...
echo -e "${MB}————————————————————————————————————————————————————————${NC}"
echo -e ""
echo -e " ${WB}[1]${NC} ${GB}Create Account Trojan${NC} "
echo -e " ${WB}[2]${NC} ${GB}Trial Account Trojan${NC} "
echo -e " ${WB}[3]${NC} ${GB}Extend Account Trojan${NC} "
echo -e " ${WB}[4]${NC} ${GB}Delete Account Trojan${NC} "
